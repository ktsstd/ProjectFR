...
public class SoundManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip[] SfxItemAudio;
    ...
    public void PlayItemSfx(int index, Vector3 position)
    {
        AudioSource.PlayClipAtPoint(SfxItemAudio[index], position, SfxVolume);
    }
