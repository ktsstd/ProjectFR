...
Shader "Amplify Shader/SBS/9week/FX_Additive"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 temp_output_11_0 = pow( tex2D( _MainTex, uv0_MainTex ) , temp_cast_0 );
			o.Emission = ( _Main_Color * temp_output_11_0 * i.vertexColor ).rgb;
...
/*ASEBEGIN
Version=16700
682.6667;344.6667;1359;951;754.7283;405.203;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;14;45.57467,-267.6478;Float;False;Property;_Main_Color;Main_Color;2;1;[HDR];Create;True;0;0;False;0;1,1,1,0;0.7490196,0.7490196,0.7490196,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=65C731E28D3B928ABB6DDFE89E6DAD628375D865