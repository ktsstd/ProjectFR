...
Shader "amplifyShader/Skill/FX_Water_Shock_Wave_AB"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 temp_output_10_0 = ( (UnpackNormal( tex2D( _Normal_Tex, panner4 ) )).xy * i.uv2_tex4coord2.y );
			float2 uv0_Main_Tex = i.uv_texcoord * _Main_Tex_ST.xy + _Main_Tex_ST.zw;
			float2 appendResult17 = (float2(uv0_Main_Tex.x , ( uv0_Main_Tex.y + i.uv2_tex4coord2.z )));
...
/*ASEBEGIN
Version=16700
492.6667;792;908;560;2480.862;390.6462;2.434557;True;False
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;14;-1008.985,-71.29071;Float;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;26;557.7083,-281.9803;Float;False;Property;_Main_Ins;Main_Ins;3;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;688.6883,-182.6538;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;843.0878,-185.3897;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=F4CAC807AB5B83A2956381742AF0FCDA17B99A07