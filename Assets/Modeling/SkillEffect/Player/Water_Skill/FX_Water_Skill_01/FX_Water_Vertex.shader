...
Shader "amplifyShader/Skill/FX_Water_Vertex"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv0_Normal_Tex = v.texcoord.xy * _Normal_Tex_ST.xy + _Normal_Tex_ST.zw;
			float2 panner36 = ( 1.0 * _Time.y * appendResult37 + uv0_Normal_Tex);
			#ifdef _CUSTOM_DISTORTION_ON
				float staticSwitch54 = v.texcoord.w;
			#else
				float staticSwitch54 = _Distortion;
			#endif
			float3 temp_output_40_0 = ( (tex2Dlod( _Normal_Tex, float4( panner36, 0, 0.0) )).rga * staticSwitch54 );
			float2 uv0_Mask_Tex = v.texcoord.xy * _Mask_Tex_ST.xy + _Mask_Tex_ST.zw;
			float4 tex2DNode46 = tex2Dlod( _Mask_Tex, float4( ( temp_output_40_0 + float3( uv0_Mask_Tex ,  0.0 ) ).xy, 0, 0.0) );
			float2 appendResult58 = (float2(_Vertex_UPanner , _Vertex_VPanner));
			float2 uv0_Vertex_Tex = v.texcoord.xy * _Vertex_Tex_ST.xy + _Vertex_Tex_ST.zw;
			float2 panner60 = ( 1.0 * _Time.y * appendResult58 + uv0_Vertex_Tex);
			#ifdef _USE_VERTEX_ON
				float staticSwitch70 = v.texcoord.x;
			#else
				float staticSwitch70 = _Vertex_Normal_Str;
			#endif
			v.vertex.xyz += ( ase_vertexNormal * ( saturate( ( tex2DNode46.r * (0.0 + (( tex2Dlod( _Vertex_Tex, float4( panner60, 0, 0.0) ).r + 0.2 ) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ) ) * staticSwitch70 ) );
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode46 = tex2D( _Mask_Tex, ( temp_output_40_0 + float3( uv0_Mask_Tex ,  0.0 ) ).xy );
			o.Alpha = ( i.vertexColor.a * saturate( ( ( tex2DNode1.r + staticSwitch52 ) * tex2DNode46.r * _Opacity ) ) );
		}
...
/*ASEBEGIN
Version=16700
697;219;1221;663;1224.902;188.3621;1.683128;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-3000.156,-68.31478;Float;False;Property;_Normal_VPanner;Normal_VPanner;15;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-2350.78,-124.7229;Float;False;Property;_Distortion;Distortion;16;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-2292.027,379.6261;Float;False;Property;_Main_VPanner;Main_VPanner;7;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-2491.346,1079.249;Float;False;Property;_Vertex_UPanner;Vertex_UPanner;23;0;Create;True;0;0;False;0;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-2484.847,1201.449;Float;False;Property;_Vertex_VPanner;Vertex_VPanner;24;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;59;-2452.346,921.9489;Float;False;0;55;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-1528.054,-626.4826;Float;False;Property;_HighLight_VPanner;HighLight_VPanner;12;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;58;-2256.047,1141.649;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-1228.474,311.9125;Float;False;Property;_Color_Offset;Color_Offset;2;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1527.009,100.5579;Float;True;Property;_Main_Tex;Main_Tex;1;0;Create;True;0;0;False;0;8a5ddd14328309c4eb65d01f184ace08;8a5ddd14328309c4eb65d01f184ace08;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;60;-2103.948,940.1489;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;55;-1779.075,922.8682;Float;True;Property;_Vertex_Tex;Vertex_Tex;22;0;Create;True;0;0;False;0;4e3a7746fb30a7346a4ad9b749d8e3cd;4e3a7746fb30a7346a4ad9b749d8e3cd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;62;-1572.489,1113.902;Float;False;Constant;_Float0;Float 0;25;0;Create;True;0;0;False;0;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;48;-2224.679,573.8022;Float;False;0;46;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-941.4739,256.9125;Float;False;Property;_Color_Range;Color_Range;3;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;16;-921.4739,135.9125;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-1316.489,1286.902;Float;False;Constant;_Float2;Float 2;25;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;47;-1675.483,596.3865;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;64;-1324.489,1198.902;Float;False;Constant;_Float1;Float 1;25;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;61;-1409.489,971.9025;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-657.8821,-1076.122;Float;False;Property;_HighLight_Range;HighLight_Range;10;0;Create;True;0;0;False;0;0.1607939;0.139;0.01;0.9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;46;-1519.167,561.8892;Float;True;Property;_Mask_Tex;Mask_Tex;18;0;Create;True;0;0;False;0;7f78920f34007b34ca97216413e97960;7f78920f34007b34ca97216413e97960;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-777.9534,-889.0825;Float;True;Property;_HighLight_Tex;HighLight_Tex;8;0;Create;True;0;0;False;0;c10244bcb5987bd41b64e7758c3af36f;8770ffa4a97cb4e458fe0316a8cc0731;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TFHCRemapNode;63;-1126.489,1061.902;Float;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;-830.4893,906.9025;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;22;-803.4739,-57.08751;Float;False;Property;_Color_B;Color_B;5;1;[HDR];Create;True;0;0;False;0;0.745283,1,0.9340957,0;0.261392,0.3113208,0.2982625,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;69;-678.4893,1175.902;Float;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;21;-812.4739,-241.0875;Float;False;Property;_Color_A;Color_A;4;1;[HDR];Create;True;0;0;False;0;0,0.7448976,1,0;0,0.6537182,0.8773585,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;71;-745.4893,1041.902;Float;False;Property;_Vertex_Normal_Str;Vertex_Normal_Str;25;0;Create;True;0;0;False;0;0;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-399.1824,-1195.723;Float;False;Property;_Color_High;Color_High;9;1;[HDR];Create;True;0;0;False;0;1,1,1,0;0.3773585,0.3773585,0.3773585,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;50;-1142.576,678.8755;Float;False;Property;_Opacity;Opacity;19;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;19;-635.4739,141.9125;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;67;-692.4893,910.9025;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;70;-462.4893,1044.902;Float;False;Property;_USE_Vertex;USE_Vertex;26;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-907.5762,530.8755;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;68;-209.4893,907.9025;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=752AC26BEA485D9272F4A76E158C04A2B7B9118A